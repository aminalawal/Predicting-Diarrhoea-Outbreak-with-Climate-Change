...
if data == 'mnist':
    ...
    print("I came to the save plot sample option")
    print("----------------vis real shape-------------------------------------")
    print(vis_real.shape)
    plotting.save_plot_sample(vis_real, 0, identifier + '_real', n_samples=9, 
...
for epoch in range(num_epochs):
    ...
    if epoch % vis_freq == 0:
        ...
        #added 3 lines    # save the generated samples in cased they might be useful for comparison
        
        plotting.save_samples(vis_sample, settings['identifier'], epoch)
        t = time() - t0
        print('Epoch:{} | Plotted {} gs_samples | Saved {} gs_samples | Time:{}.'.format(epoch, 9, vis_sample.shape[0], t))#changed 6 to 9
    #hashim=18
   # that_np=0
